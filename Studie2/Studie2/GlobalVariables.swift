...
let globalAssignments:[Assignment] = [Assignment(headline: "Task 1", descriptionText: "", targetBeacon: 1, descriptionTextShort: "Gå till fråga 1."), Assignment(headline: "Task 2", descriptionText: "", targetBeacon: 4,  descriptionTextShort: "Gå till fråga 2."), Assignment(headline: "Task 3", descriptionText: "", targetBeacon: 5,  descriptionTextShort: "Gå till fråga 3"), Assignment(headline: "Task 4", descriptionText: "", targetBeacon: 6,  descriptionTextShort: "Gå till fråga 4."), Assignment(headline: "Task 5", descriptionText: "", targetBeacon: 8,  descriptionTextShort: "Få till fråga 5.")]
