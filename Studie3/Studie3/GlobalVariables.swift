...
let globalAssignments:[Assignment] = [
    Assignment(product: "Avokado", checked: false,assignmentNumber: 1, majorVersion: 1, minorVersion: 0, offer: "Du kan just nu köpa 2 avocado för halva priset", beacontriggered: false, qheadline:"Kravodlad avokado", qquestion: "Vilket land i världen odlar mest kravavokado?", qalternative1: "Sverige", qalternative2: "Norge", qalternative3: "Danmark", qalternative4: "Finland", qrightAlternative: 1, quserAnswer:0, qfiftyFiftyRemove:[2,3], qpercentAlternative1:11, qpercentAlternative2:21,qpercentAlternative3:31,qpercentAlternative4:41),
